...
//   function isShuffledBattleStonesIndicesFilled() external view returns (uint256); 
//   function isShuffledBattleShieldIndicesFilled() external view returns (uint256); 
//   function isShuffledLuckTokenIndicesFilled() external view returns (uint256); 
