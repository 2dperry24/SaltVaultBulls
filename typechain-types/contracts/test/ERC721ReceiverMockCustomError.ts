...
export interface ERC721ReceiverMockCustomErrorInterface extends Interface {
...
export interface ERC721ReceiverMockCustomError extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721ReceiverMockCustomError;
  waitForDeployment(): Promise<this>;

  interface: ERC721ReceiverMockCustomErrorInterface;
