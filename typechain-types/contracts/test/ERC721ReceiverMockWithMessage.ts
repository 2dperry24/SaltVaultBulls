...
export interface ERC721ReceiverMockWithMessageInterface extends Interface {
...
export interface ERC721ReceiverMockWithMessage extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721ReceiverMockWithMessage;
  waitForDeployment(): Promise<this>;

  interface: ERC721ReceiverMockWithMessageInterface;
