import { BaseContract, Contract, ContractFactory, FunctionFragment, ethers } from "ethers"
...
export function getSelectors(contract: Contract | ContractFactory<any[], BaseContract>): SelectorsObj {
    const signatures = Object.values(contract.interface.fragments.filter((fragment) => fragment.type === "function")) as FunctionFragment[]
